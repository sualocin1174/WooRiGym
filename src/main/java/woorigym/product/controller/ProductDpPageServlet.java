...
/**
 * Servlet implementation class ProductDpPageServlet
 */
@WebServlet("/productdppage")
public class ProductDpPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductDpPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productdppage.jsp";
