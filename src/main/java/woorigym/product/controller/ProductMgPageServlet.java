...
/**
 * Servlet implementation class ProductMgPageServlet
 */
@WebServlet("/productmgpage")
public class ProductMgPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductMgPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productmgpage.jsp";
