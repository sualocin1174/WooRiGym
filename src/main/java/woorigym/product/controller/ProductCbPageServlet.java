...
/**
 * Servlet implementation class ProductCbPageServlet
 */
@WebServlet("/productcbpage")
public class ProductCbPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductCbPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productcbpage.jsp";
