...
/**
 * Servlet implementation class ProductRnPageServlet
 */
@WebServlet("/productrnpage")
public class ProductRnPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductRnPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productrnpage.jsp";
