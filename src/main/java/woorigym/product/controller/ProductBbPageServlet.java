...
/**
 * Servlet implementation class ProductBbPageServlet
 */
@WebServlet("/productbbpage")
public class ProductBbPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductBbPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productbbpage.jsp";
