...
/**
 * Servlet implementation class ProductCcPageServlet
 */
@WebServlet("/productccpage")
public class ProductCcPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductCcPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productccpage.jsp";
