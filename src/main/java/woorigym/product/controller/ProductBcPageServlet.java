...
/**
 * Servlet implementation class ProductBcPageServlet
 */
@WebServlet("/productbcpage")
public class ProductBcPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductBcPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productbcpage.jsp";
