...
/**
 * Servlet implementation class ProductMjPageServlet
 */
@WebServlet("/productmjpage")
public class ProductMjPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductMjPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productmjpage.jsp";
