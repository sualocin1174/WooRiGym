...
/**
 * Servlet implementation class ProductAsstPageServlet
 */
@WebServlet("/productasstpage")
public class ProductAsstPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductAsstPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productasstpage.jsp";
