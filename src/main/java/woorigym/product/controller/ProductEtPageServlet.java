...
/**
 * Servlet implementation class ProductEtPageServlet
 */
@WebServlet("/productetpage")
public class ProductEtPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductEtPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productetpage.jsp";
