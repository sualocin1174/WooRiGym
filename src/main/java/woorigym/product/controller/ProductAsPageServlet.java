...
/**
 * Servlet implementation class ProductAsPageServlet
 */
@WebServlet("/productaspage")
public class ProductAsPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductAsPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productaspage.jsp";
