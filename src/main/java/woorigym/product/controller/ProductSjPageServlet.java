...
/**
 * Servlet implementation class ProductSjPageServlet
 */
@WebServlet("/productsjpage")
public class ProductSjPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductSjPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productsjpage.jsp";
