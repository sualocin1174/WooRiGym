...
/**
 * Servlet implementation class ProductCmPageServlet
 */
@WebServlet("/productcmpage")
public class ProductCmPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductCmPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productcmpage.jsp";
