...
/**
 * Servlet implementation class ProductOtPageServlet
 */
@WebServlet("/productotpage")
public class ProductOtPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductOtPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productotpage.jsp";
