...
/**
 * Servlet implementation class ProductDbPageServlet
 */
@WebServlet("/productdbpage")
public class ProductDbPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductDbPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productdbpage.jsp";
