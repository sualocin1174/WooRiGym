...
/**
 * Servlet implementation class ProductWlPageServlet
 */
@WebServlet("/productwlpage")
public class ProductWlPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductWlPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productwlpage.jsp";
