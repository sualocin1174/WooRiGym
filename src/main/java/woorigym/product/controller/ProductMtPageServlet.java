...
/**
 * Servlet implementation class ProductMtPageServlet
 */
@WebServlet("/productmtpage")
public class ProductMtPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductMtPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productmtpage.jsp";
