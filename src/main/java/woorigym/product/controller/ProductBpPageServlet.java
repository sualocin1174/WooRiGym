...
/**
 * Servlet implementation class ProductBpPageServlet
 */
@WebServlet("/productbppage")
public class ProductBpPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductBpPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productbppage.jsp";
