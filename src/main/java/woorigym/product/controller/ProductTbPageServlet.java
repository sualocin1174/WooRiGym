...
/**
 * Servlet implementation class ProductTbPageServlet
 */
@WebServlet("/producttbpage")
public class ProductTbPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductTbPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/producttbpage.jsp";
