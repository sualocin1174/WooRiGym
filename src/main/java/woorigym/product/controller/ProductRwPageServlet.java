...
/**
 * Servlet implementation class ProductRwPageServlet
 */
@WebServlet("/productrwpage")
public class ProductRwPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ProductRwPageServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String viewPage = "/WEB-INF/productrwpage.jsp";
