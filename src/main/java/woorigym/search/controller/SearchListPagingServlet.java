...
//public class SearchListPagingServlet implements Command{
...
//		if(endPage > pageCount) endPage=pageCount;
		...
		// DB에서 값 읽어오기
//		ArrayList<ProductTable> volist = new BoardService().selectBoardList(startRnum,endRnum);
		
		// Data 전달을 위해서 request에 셋
//		request.setAttribute("boardvolist", volist);
//		request.setAttribute("startPage", startPasssge);
